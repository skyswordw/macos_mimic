...
const Launchpad = () => {
    ...
    return (
        <div
            className={`absolute inset-0 z-40 backdrop-blur-2xl flex flex-col items-center pt-12 sm:pt-20 animate-fadeIn transition-colors duration-500 ${
        ...
        >
            ...
            >
                {filteredApps.map(app => (
                    ...
                    >
                        <div className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl sm:rounded-[2rem] shadow-xl flex items-center justify-center text-3xl sm:text-4xl md:text-5xl transition-all duration-300 group-hover:scale-110 active:scale-95 ${
